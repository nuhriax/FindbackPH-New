...
export default function SafetyPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#06080b] text-white">
      ...
      >
        ...
        {/* Green atmosphere */}
        <div className="absolute -left-[350px] top-[1800px] h-[700px] w-[700px] rounded-full bg-emerald-400/[0.022] blur-[180px]" />
        ...
        {/* Vignette */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,rgba(6,8,11,.35)_70%,rgba(6,8,11,.8)_100%)]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-[1440px] px-5 sm:px-8 lg:px-12">
        ...
        <section className="relative min-h-[820px] overflow-hidden">
          ...
          <div className="pointer-events-none absolute inset-0">
            <div className="absolute left-[7%] top-0 hidden h-full w-px bg-gradient-to-b from-transparent via-white/[0.055] to-transparent lg:block" />

            <div className="absolute left-0 right-0 top-[49%] h-px bg-gradient-to-r from-transparent via-white/[0.025] to-transparent" />
          </div>
          ...
          <div className="grid min-h-[820px] items-center gap-14 lg:grid-cols-[.92fr_1.08fr]">
            ...
            <div className="relative z-20 py-24 lg:pl-16">
              ...
              <div className="mb-10 flex items-center gap-4">
                ...
                <span className="text-[10px] font-semibold uppercase tracking-[0.32em] text-emerald-400">
                  FindBack PH / Safety Center
                </span>

                <span className="hidden h-px w-14 bg-white/[0.08] sm:block" />
              ...
              <h1 className="max-w-5xl font-display text-[4rem] font-semibold leading-[0.86] tracking-[-0.07em] sm:text-7xl lg:text-[7.25rem]">
                ...
                <span className="block bg-gradient-to-r from-white via-blue-200 to-emerald-300 bg-clip-text text-transparent">
                  compromise.
                </span>

              </h1>

              <div className="mt-10 max-w-xl border-l border-emerald-400/30 pl-6">
              ...
              <div className="mt-10 flex flex-wrap gap-3">
                ...
                <div className="flex items-center gap-2.5 rounded-full border border-white/[0.07] bg-white/[0.025] px-4 py-2.5 text-xs text-slate-400 shadow-2xl backdrop-blur-xl">
                  <ShieldCheck
                    size={14}
            ...
            <div className="relative flex min-h-[650px] items-center justify-center">
              ...
              <div className="absolute h-[600px] w-[600px] rounded-full border border-white/[0.025]" />

              <div className="absolute h-[500px] w-[500px] rounded-full border border-blue-400/[0.055]" />

              <div className="absolute h-[400px] w-[400px] rounded-full border border-blue-400/[0.07]" />

              <div className="absolute h-[300px] w-[300px] rounded-full border border-emerald-400/[0.08]" />
              ...
              <div className="absolute h-[600px] w-px bg-gradient-to-b from-transparent via-blue-400/[0.07] to-transparent" />

              <div className="absolute h-px w-[600px] bg-gradient-to-r from-transparent via-blue-400/[0.07] to-transparent" />
              ...
              <div className="relative flex h-52 w-52 items-center justify-center rounded-full border border-white/[0.1] bg-[#080b10]/90 shadow-[0_0_120px_rgba(59,130,246,.12)] backdrop-blur-2xl">

                <div className="absolute inset-5 rounded-full border border-white/[0.04]" />

                <div className="absolute inset-10 rounded-full border border-blue-400/[0.07]" />
                ...
                <div className="absolute -bottom-5 rounded-full border border-emerald-400/20 bg-[#070a0e] px-5 py-2.5 shadow-2xl">

                  <span className="flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.25em] text-emerald-400">
              ...
              <div className="absolute left-[0%] top-[13%] rounded-2xl border border-white/[0.07] bg-[#080b10]/80 p-4 shadow-2xl backdrop-blur-xl">
              ...
              <div className="absolute right-[0%] top-[22%] rounded-2xl border border-white/[0.07] bg-[#080b10]/80 p-4 shadow-2xl backdrop-blur-xl">

                <div className="flex items-center gap-3">

                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-400/[0.06]">
                    <UserCheck
                      size={15}
                      className="text-blue-400"
                    />
              ...
              <div className="absolute bottom-[13%] left-[7%] rounded-2xl border border-white/[0.07] bg-[#080b10]/80 p-4 shadow-2xl backdrop-blur-xl">

                <div className="flex items-center gap-3">

                  <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-400/[0.06]">
                    <MapPin
                      size={15}
        ...
        <section className="relative border-t border-white/[0.06] py-32 sm:py-40">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-0 left-[31px] top-0 hidden w-px bg-gradient-to-b from-blue-400/30 via-white/[0.07] to-transparent lg:block" />
            ...
            {[
              ...
              return (
                <div
                  key={item.number}
                  className="group relative grid gap-8 border-t border-white/[0.06] py-10 lg:grid-cols-[64px_1fr_1.2fr] lg:items-center"
                >

                  <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-full border border-white/[0.08] bg-[#070a0e] shadow-xl">
                  ...
                  <p className="max-w-xl text-sm leading-7 text-slate-500 transition-colors duration-500 group-hover:text-slate-300">
                    {item.text}
                  </p>
        ...
        <section className="relative py-32 sm:py-40">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-white/[0.07] bg-gradient-to-br from-white/[0.035] via-white/[0.015] to-transparent">

            {/* Decorative number */}

            <div className="pointer-events-none absolute -right-8 -top-16 select-none font-display text-[14rem] font-bold leading-none tracking-[-0.1em] text-white/[0.018]">
              02
            </div>
            ...
            <div className="grid gap-16 p-8 sm:p-12 lg:grid-cols-[.8fr_1.2fr] lg:p-16">
              ...
              <div className="border-l border-white/[0.06] pl-7 sm:pl-10">

                {preparationSteps.map((item, index) => (
                  <div
                    key={item}
                    className="group flex items-center gap-5 border-b border-white/[0.06] py-6 first:pt-0 last:border-0"
                  >

                    <span className="font-mono text-[9px] text-blue-400/40">
                      {String(index + 1).padStart(2, "0")}
                    </span>

                    <CheckCircle
                      size={17}
                      className="shrink-0 text-emerald-400/70 transition-transform duration-300 group-hover:scale-110"
                    />
        ...
        <section className="relative border-t border-white/[0.06] py-32 sm:py-40">
          ...
          <div className="grid items-center gap-20 lg:grid-cols-[.8fr_1.2fr]">
            ...
            <div>
              ...
              <div className="mt-9 flex items-start gap-3 rounded-2xl border border-emerald-400/10 bg-emerald-400/[0.025] p-4">
            ...
            <div className="grid gap-px overflow-hidden rounded-[2rem] border border-white/[0.07] bg-white/[0.06] sm:grid-cols-2">
              ...
              {meetupPlaces.map((place, index) => {
                ...
                return (
                  <div
                    key={place.title}
                    className="group relative bg-[#090c11] p-8 transition-all duration-500 hover:bg-[#0c1016]"
                  >
                    ...
                    <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-emerald-400/15 bg-emerald-400/[0.045] transition-all duration-500 group-hover:border-emerald-400/30 group-hover:bg-emerald-400/[0.07]">
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-600 transition-colors group-hover:text-slate-500">
                      {place.text}
                    </p>
        ...
        <section className="relative py-32 sm:py-40">
          ...
          <div className="absolute left-0 right-0 top-1/2 h-px bg-gradient-to-r from-transparent via-red-400/[0.07] to-transparent" />
          ...
          <div className="grid items-center gap-20 lg:grid-cols-[1fr_.9fr]">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-red-400">
            ...
            <div className="relative">
              ...
              <div className="absolute -inset-12 rounded-[3rem] bg-red-400/[0.018] blur-3xl" />

              <div className="relative overflow-hidden rounded-[2rem] border border-red-400/10 bg-[#090c11]/95 shadow-[0_30px_120px_rgba(0,0,0,.4)]">
                ...
                <div className="p-6">
                  ...
                  {privacyItems.map((item, index) => (
                    ...
                    <div
                      key={item}
                      className="group flex items-center justify-between border-b border-white/[0.05] py-5 last:border-0"
                    >
                ...
                <div className="border-t border-red-400/10 bg-red-400/[0.025] px-6 py-5">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-xs leading-5 text-red-300/70">
            ...
            <div className="space-y-3">
              ...
              {verificationSteps.map((item) => {
                ...
                return (
                  <div
                    key={item.number}
                    className="group relative overflow-hidden border-y border-white/[0.06] py-8 transition-colors duration-500 hover:bg-white/[0.015] sm:px-6"
                  >

                    <div className="flex gap-6">

                      <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-blue-400/15 bg-blue-400/[0.045]">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex flex-wrap items-center gap-3">
                          ...
                          <span className="font-mono text-[8px] uppercase tracking-[0.2em] text-blue-400/60">
                            {item.label}
                          </span>
                    ...
                    <MoveRight
                      size={17}
                      className="absolute right-5 top-1/2 hidden -translate-y-1/2 text-blue-400/0 transition-all duration-500 group-hover:right-3 group-hover:text-blue-400/50 sm:block"
                    />
        ...
        <section className="relative py-32 sm:py-40">
          ...
          <div className="mb-16 flex items-end justify-between">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-[9px] uppercase tracking-[0.3em] text-amber-400">
          ...
          <div className="grid border-y border-white/[0.07] lg:grid-cols-2">

            {redFlags.map((item, index) => (

              <div
                key={item}
                className={`group relative overflow-hidden border-b border-white/[0.06] p-8 transition-all duration-500 hover:bg-amber-400/[0.025] ${
                  index % 2 === 0
                    ? "lg:border-r"
                    : ""
                }`}
              >
                ...
                <div className="flex gap-6">
                  ...
                  <span className="font-mono text-[10px] text-amber-400/40">
                    {String(index + 1).padStart(2, "0")}
                  </span>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="max-w-lg text-sm leading-7 text-slate-400 transition-colors duration-300 group-hover:text-slate-200">
                      {item}
                    </p>
                  ...
                  <AlertTriangle
                    size={15}
                    className="text-amber-400/30 transition-colors group-hover:text-amber-400"
                  />
          ...
          <div className="mt-8 flex items-center gap-3 text-xs text-amber-400/70">
            <Radar size={15} />
        ...
        <section className="relative border-t border-white/[0.06] py-32 sm:py-40">
          ...
          <div className="relative mx-auto max-w-5xl text-center">
            ...
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-blue-400/15 bg-blue-400/[0.045] shadow-[0_0_60px_rgba(59,130,246,.06)]">
            ...
            <span className="mt-7 block font-mono text-[9px] uppercase tracking-[0.3em] text-blue-400">
              You are in control
            </span>
            ...
            <div className="mt-14 grid grid-cols-2 overflow-hidden rounded-[2rem] border border-white/[0.07] sm:grid-cols-4">
              ...
              {[
                ...
                return (
                  <div
                    key={item.label}
                    className={`group flex flex-col items-center justify-center py-10 transition-all duration-500 hover:bg-white/[0.025] ${
                      index !== 3
                  ...
                  >
                    ...
                    <Icon
                      size={20}
                      className="text-blue-400 transition-transform duration-500 group-hover:-translate-y-1"
                    />

                    <span className="mt-4 text-[10px] font-semibold uppercase tracking-[0.25em] text-slate-500 transition-colors group-hover:text-white">
                      {item.label}
                    </span>
        ...
        <section className="border-y border-red-400/10 py-10 sm:py-12">

          <div className="flex flex-col gap-6 lg:flex-row lg:items-center">

            <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-red-400/15 bg-red-400/[0.05]">
            ...
            <button
              type="button"
              className="group flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.12em] text-red-400 transition-colors hover:text-red-300"
            >
        ...
        <section className="py-16 sm:py-20">
          ...
          <div className="rounded-3xl border border-white/[0.06] bg-white/[0.012] p-6 sm:p-8">

            <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:gap-6">

              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/[0.08]">
        ...
        <section className="relative overflow-hidden py-32 text-center sm:py-48">
          ...
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[550px] w-[550px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-400/[0.025] blur-[160px]" />

          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[420px] w-[420px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-emerald-400/[0.035]" />

          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[600px] w-[600px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/[0.02]" />

          <div className="relative mx-auto max-w-5xl">

            <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full border border-emerald-400/20 bg-emerald-400/[0.045] shadow-[0_0_80px_rgba(52,211,153,.06)]">
            ...
            <div className="mt-8 flex items-center justify-center gap-2 font-mono text-[9px] uppercase tracking-[0.35em] text-emerald-400">
            ...
            <div className="mt-12 flex flex-wrap items-center justify-center gap-3">
              ...
              <div className="flex items-center gap-2 rounded-full border border-white/[0.07] bg-white/[0.02] px-5 py-3 text-xs text-slate-500">
                <ShieldCheck
                  size={15}
                  className="text-emerald-400"
                />
