...
function LoginInner() {
  ...
  // Respect the protected-page redirect the middleware set (e.g. /report/lost),
  // falling back to the homepage. Reject external/open redirects and auth
  // pages themselves as targets.
