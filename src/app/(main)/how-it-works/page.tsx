  ...
  return (
    <main className="relative min-h-screen overflow-hidden py-16 text-navy-900 selection:bg-electric-400/20 selection:text-navy-900 lg:py-24">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        {/* Main ambient glow */}
        <div className="absolute left-1/2 top-[-280px] h-[700px] w-[1100px] -translate-x-1/2 rounded-full bg-electric-400/[0.055] blur-[160px]" />

        {/* Subtle atmosphere */}
        <div className="absolute left-[-250px] top-[25%] h-[500px] w-[500px] rounded-full bg-blue-500/[0.025] blur-[150px]" />

        <div className="absolute right-[-250px] top-[55%] h-[550px] w-[550px] rounded-full bg-electric-500/[0.02] blur-[160px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        ========================================================== */}
          ...
          <div className="pointer-events-none absolute -left-4 top-20 hidden lg:block">
            <div className="flex h-14 w-14 rotate-[-8deg] items-center justify-center rounded-2xl border border-slate-200 bg-slate-50 text-electric-700 shadow-[0_20px_50px_rgba(0,0,0,0.2)] backdrop-blur-xl">
          ...
          <div className="mx-auto mb-7 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-medium text-slate-700 shadow-lg shadow-slate-900/5 backdrop-blur-xl">
            <Sparkles size={13} className="text-electric-700" />
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              href="/search"
              className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-b from-electric-300 to-electric-400 px-6 py-3.5 text-sm font-semibold text-navy-950 shadow-[0_12px_35px_rgba(15,123,122,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_45px_rgba(15,123,122,0.45)] active:translate-y-0"
            >
              Find a Lost Item
              <ArrowRight
                size={17}
            ...
            >
              <ClipboardList size={17} className="text-electric-700" />
              I Found Something
            </Link>
          </div>
              ...
              return (
                ...
                >
                  <Icon
                    size={14}
                    strokeWidth={1.8}
                    className="text-electric-700 transition-transform duration-300 group-hover:scale-110"
                  />
                  {item.text}
                </div>
              );
          ...
          <div className="grid overflow-hidden rounded-[1.5rem] border border-slate-200 bg-slate-50 shadow-[0_20px_70px_rgba(0,0,0,0.15)] backdrop-blur-xl sm:grid-cols-3">
            {stats.map((stat, index) => {
              ...
              return (
                ...
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-electric-200 bg-electric-50 text-electric-700">
        ...
        <section className="mx-auto mt-24 max-w-6xl lg:mt-32">
          <div className="mb-10 text-center">
            <span className="text-xs font-semibold tracking-[0.18em] text-electric-700/80">
          ...
          <div className="relative rounded-[1.75rem] border border-slate-200 bg-slate-50 p-6 shadow-[0_25px_80px_rgba(0,0,0,0.18)] backdrop-blur-xl sm:p-9">
            {/* Connecting line */}
            <div className="absolute left-[8%] right-[8%] top-[68px] hidden h-px bg-gradient-to-r from-transparent via-electric-300/20 to-transparent lg:block" />
                ...
                return (
                  ...
                  >
                    <div className="relative z-10">
                      <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-slate-200 bg-white text-electric-700 shadow-xl transition-all duration-300 group-hover:-translate-y-1 group-hover:border-electric-300 group-hover:bg-electric-50">
                        <Icon size={20} strokeWidth={1.8} />
                      </div>

                      <span className="absolute -right-2 -top-2 flex h-5 min-w-5 items-center justify-center rounded-full border border-electric-300 bg-electric-300 px-1 text-[9px] font-bold text-navy-950">
                        {index + 1}
                      </span>
                    </div>
        ...
        <section className="mt-24 lg:mt-36">
          ...
          <div className="relative overflow-hidden rounded-[2rem] border border-slate-200 bg-gradient-to-br from-electric-400/[0.055] via-white/60 to-transparent p-5 shadow-[0_30px_100px_rgba(0,0,0,0.22)] sm:p-8 lg:p-10">
            {/* Ambient glow */}
            <div className="pointer-events-none absolute left-1/2 top-[-120px] h-72 w-96 -translate-x-1/2 rounded-full bg-electric-400/[0.055] blur-[100px]" />
            ...
            <div className="relative grid items-center gap-5 lg:grid-cols-[1fr_auto_1fr]">
                    ...
                    return (
                      ...
                      >
                        <ItemIcon
                          size={15}
                          strokeWidth={1.8}
                          className="text-electric-700/80"
                        />
                        {text as string}
                      </div>
                    );
              ...
              <div className="relative flex flex-col items-center justify-center">
                <div className="relative flex h-20 w-20 items-center justify-center rounded-[1.5rem] border border-electric-300/20 bg-electric-50 text-electric-700 shadow-[0_0_50px_rgba(15,123,122,0.22)]">
                  <div className="absolute inset-[-8px] rounded-[1.7rem] border border-electric-200" />

                  <Sparkles size={27} strokeWidth={1.6} />

                  <div className="absolute inset-0 animate-ping rounded-[1.5rem] border border-electric-200" />
                </div>

                <span className="mt-4 rounded-full border border-electric-200 bg-electric-50 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.12em] text-electric-600">
                  Possible match
                </span>
              </div>
        ...
        ========================================================== */}
        <InPageNav
          className="mx-auto mt-14 max-w-4xl lg:mt-20"
          items={[
            { id: "steps", label: "Six simple steps" },
            { id: "features", label: "Built around real people" },
            { id: "safety", label: "Keep every handover safe." },
            { id: "faq", label: "Everything you need to know" },
          ]}
        />
        ...
        {/* =========================================================
            SIX STEPS
        ========================================================== */}
        <section id="steps" className="relative mx-auto mt-24 max-w-6xl scroll-mt-28 lg:mt-36">
          ...
          {/* Timeline */}
          <div className="absolute bottom-20 left-[25px] top-44 hidden w-px bg-gradient-to-b from-electric-300 via-electric-200 to-transparent md:block lg:left-1/2 lg:-translate-x-1/2" />
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="pointer-events-none absolute -right-20 -top-20 h-40 w-40 rounded-full bg-electric-50/60 blur-3xl transition-all duration-500 group-hover:bg-electric-300/[0.055]" />
                      ...
                      >
                        <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl border border-electric-200 bg-electric-50 text-electric-700 transition-all duration-300 group-hover:scale-105 group-hover:border-electric-300/[0.18]">
                          <Icon size={23} strokeWidth={1.7} />
                        </div>

                        <div className="flex-1">
                          <span className="text-[10px] font-semibold uppercase tracking-[0.18em] text-electric-700/75">
                            {step.label}
                          </span>
                      ...
                      >
                        ...
                        <span className="text-electric-700/60">
                          FindBack
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="absolute left-0 top-8 hidden md:relative md:col-start-2 md:row-start-1 md:flex md:justify-center">
                    <div className="relative flex h-11 w-11 items-center justify-center rounded-full border border-electric-300/[0.12] bg-white shadow-[0_0_35px_rgba(15,123,122,0.16)]">
                      <div className="h-2.5 w-2.5 rounded-full bg-electric-300 shadow-[0_0_14px_rgba(15,123,122,0.7)] transition-transform duration-300 group-hover:scale-150" />
                    </div>
                  </div>
                </div>
              );
        ...
        {/* =========================================================
            FEATURES
        ========================================================== */}
        <section id="features" className="mt-24 scroll-mt-28 lg:mt-36">
            ...
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="relative flex h-12 w-12 items-center justify-center rounded-2xl border border-electric-200 bg-electric-50 text-electric-700 transition-all duration-300 group-hover:scale-105 group-hover:bg-electric-300/[0.08]">
                  ...
                  <div className="mt-7 h-px w-10 bg-electric-300/20 transition-all duration-300 group-hover:w-16 group-hover:bg-electric-300/40" />
                </div>
              );
            })}
          </div>
        ...
        {/* =========================================================
            SAFETY
        ========================================================== */}
        <section id="safety" className="mt-24 scroll-mt-28 lg:mt-36">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-electric-200 bg-electric-300/[0.04] text-electric-700">
        ...
        {/* =========================================================
            FAQ
        ========================================================== */}
        <section id="faq" className="mx-auto mt-24 max-w-4xl scroll-mt-28 lg:mt-36">
          ...
          <div className="mt-10 space-y-3">
            {faqs.map((faq, index) => (
              <details
                key={faq.question}
                className="group overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 shadow-[0_10px_40px_rgba(0,0,0,0.1)] transition-all duration-300 open:border-electric-300 open:bg-electric-50/60 hover:border-slate-300"
              >
                <summary className="flex cursor-pointer list-none items-center gap-4 p-5 text-[15px] font-semibold leading-6 text-navy-900 sm:p-6">
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg border border-electric-200 bg-electric-50 text-[10px] font-semibold text-electric-700">
                  ...
                  <ChevronDown
                    size={18}
                    strokeWidth={1.8}
                    className="shrink-0 text-slate-500 transition-transform duration-300 group-open:rotate-180 group-open:text-electric-700"
                  />
                </summary>
        ...
        {/* =========================================================
            FINAL CTA
        ========================================================== */}
        <section className="relative mt-24 overflow-hidden rounded-[2rem] border border-slate-200 bg-gradient-to-br from-electric-400/[0.07] via-white/70 to-transparent p-8 text-center shadow-[0_30px_100px_rgba(0,0,0,0.25)] sm:p-12 lg:mt-36 lg:p-16">
          {/* Ambient glow */}
          <div className="pointer-events-none absolute left-1/2 top-[-120px] h-72 w-[500px] -translate-x-1/2 rounded-full bg-electric-400/[0.055] blur-[110px]" />

          {/* Decorative corners */}
          <div className="pointer-events-none absolute left-6 top-6 h-16 w-16 rounded-tl-2xl border-l border-t border-electric-200" />

          <div className="pointer-events-none absolute bottom-6 right-6 h-16 w-16 rounded-br-2xl border-b border-r border-electric-200" />

          <div className="relative">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl border border-electric-200 bg-electric-50 text-electric-700 shadow-[0_0_40px_rgba(15,123,122,0.16)]">
              <HeartHandshake size={28} strokeWidth={1.7} />
            </div>

            <span className="mt-6 block text-xs font-semibold tracking-[0.18em] text-electric-700/80">
              READY WHEN YOU ARE
            </span>
            ...
            <div className="mt-9 grid gap-3 sm:mx-auto sm:max-w-xl sm:grid-cols-2">
              <Link
                href="/search"
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-b from-electric-300 to-electric-400 px-6 py-3.5 text-sm font-semibold text-navy-950 shadow-[0_12px_35px_rgba(15,123,122,0.35)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_18px_45px_rgba(15,123,122,0.45)]"
              >
                Search Reports
