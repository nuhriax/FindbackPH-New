  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6">
      ...
      {(lostItems ?? []).length === 0 && (foundItems ?? []).length === 0 && (
        <div className="mt-8 overflow-hidden rounded-2xl border border-electric-100 bg-gradient-to-br from-electric-50/80 via-white to-emerald-50/40 p-6 sm:p-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-electric-600">
                Getting started
              </p>
              <h2 className="mt-2 font-display text-lg font-bold text-navy-900 sm:text-xl">
                Let&apos;s bring one thing home today
              </h2>
              <p className="mt-1 max-w-xl text-sm leading-relaxed text-slate-600">
                Post your first report to start matching with the community.
                Every return begins with one person taking a minute to care.
              </p>
            </div>
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-3">
        <StatTile icon={PackageX} tone="sunrise" label="Active lost reports" value={activeLost} />
