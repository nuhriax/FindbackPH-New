   ...
   (<html lang="en" className={`${plusJakarta.variable} ${sora.variable} ${caveat.variable}`} suppressHydrationWarning>
    <body className="flex min-h-dvh flex-col font-sans text-navy-900 antialiased">
      ...
      <a
        ...
        __html: `(function(){try{document.documentElement.setAttribute('data-auth-theme','light');localStorage.setItem('fb-auth-theme','light');}catch(e){document.documentElement.setAttribute('data-auth-theme','light');}})();`,
        }}
        />
        <MarketingBackground />
        <script
