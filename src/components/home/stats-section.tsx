      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-4 sm:gap-6 md:grid-cols-4">
          ...
          <article className="text-center">
            <div className="text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-navy-900">{fmt(lost)}</div>
            <div className="mt-2 text-slate-500 text-sm font-medium">Lost reports</div>
          </article>

          {/* Found */}
          <article className="text-center">
            <div className="text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-emerald-600">{fmt(found)}</div>
            <div className="mt-2 text-slate-500 text-sm font-medium">Found reports</div>
          </article>

          {/* Recovered */}
          <article className="text-center">
            <div className="text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-leaf-600">{fmt(recovered)}</div>
          ...
          {possibleMatches !== undefined && possibleMatches > 0 ? (
            <article className="text-center">
              <div className="text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-indigo-600">{fmt(
                possibleMatches
              )}</div>
            ...
            <article className="text-center opacity-50">
              <div className="text-4xl sm:text-5xl lg:text-7xl font-display font-bold text-slate-500">—</div>
              <div className="mt-2 text-slate-500 text-sm font-medium">Possible matches</div>
            </article>
          )}
        </div>
